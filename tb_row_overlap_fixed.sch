...
if $&overlap_max > 0.3
  echo FAIL_ROW_OVERLAP_FIXED overlap_max exceeds 0.3V
else
  echo PASS_ROW_OVERLAP_FIXED overlap_max within 0.3V
end

write tb_row_overlap_fixed.raw
.endc
"}
