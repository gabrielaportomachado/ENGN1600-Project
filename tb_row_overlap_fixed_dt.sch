...
C {row_fixed_dt.sym} 280 0 0 0 {name=x1}
...
C {res.sym} 590 -15 0 0 {name=R_IPG
value=10k
footprint=1206
device=resistor
m=1}
C {gnd.sym} 590 30 0 0 {name=l11 lab=GND}
C {res.sym} 600 85 0 0 {name=R_REC
value=10k
footprint=1206
device=resistor
m=1}
...
if $&overlap_max > 0.3
  echo FAIL_ROW_OVERLAP_FIXED_DT overlap_max exceeds 0.3V
else
  echo PASS_ROW_OVERLAP_FIXED_DT overlap_max within 0.3V
end
