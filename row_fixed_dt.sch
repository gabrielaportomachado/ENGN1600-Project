...
N 140 -40 180 -40 {lab=SW_RECb_dt}
N 140 80 180 80 {lab=SW_IPGb_dt}
...
C {lab_wire.sym} 280 60 0 0 {name=p12 sig_type=std_logic lab=SW_REC}
C {lab_wire.sym} 280 -60 0 0 {name=p13 sig_type=std_logic lab=SW_IPG}
...
C {lab_wire.sym} 170 -40 0 0 {name=p30 sig_type=std_logic lab=SW_RECb_dt}
C {lab_wire.sym} 170 80 0 0 {name=p31 sig_type=std_logic lab=SW_IPGb_dt}
...
C {AND/INV.sym} -200 280 0 0 {name=x_id1}
C {AND/INV.sym} -50 280 0 0 {name=x_id2}
C {AND/INV.sym} 100 280 0 0 {name=x_id3}
C {AND/INV.sym} 250 280 0 0 {name=x_id4}
C {lab_wire.sym} -230 280 0 0 {name=p40 sig_type=std_logic lab=SW_IPGb}
C {lab_wire.sym} -150 280 0 0 {name=p41 sig_type=std_logic lab=IPGb_d1}
C {lab_wire.sym} -80 280 0 0 {name=p42 sig_type=std_logic lab=IPGb_d1}
C {lab_wire.sym} 0 280 0 0 {name=p43 sig_type=std_logic lab=IPGb_d2}
C {lab_wire.sym} 70 280 0 0 {name=p44 sig_type=std_logic lab=IPGb_d2}
C {lab_wire.sym} 150 280 0 0 {name=p45 sig_type=std_logic lab=IPGb_d3}
C {lab_wire.sym} 220 280 0 0 {name=p46 sig_type=std_logic lab=IPGb_d3}
C {lab_wire.sym} 300 280 0 0 {name=p47 sig_type=std_logic lab=SW_IPGb_dt}
C {AND/INV.sym} -200 380 0 0 {name=x_rd1}
C {AND/INV.sym} -50 380 0 0 {name=x_rd2}
C {AND/INV.sym} 100 380 0 0 {name=x_rd3}
C {AND/INV.sym} 250 380 0 0 {name=x_rd4}
C {lab_wire.sym} -230 380 0 0 {name=p50 sig_type=std_logic lab=SW_RECb}
C {lab_wire.sym} -150 380 0 0 {name=p51 sig_type=std_logic lab=RECb_d1}
C {lab_wire.sym} -80 380 0 0 {name=p52 sig_type=std_logic lab=RECb_d1}
C {lab_wire.sym} 0 380 0 0 {name=p53 sig_type=std_logic lab=RECb_d2}
C {lab_wire.sym} 70 380 0 0 {name=p54 sig_type=std_logic lab=RECb_d2}
C {lab_wire.sym} 150 380 0 0 {name=p55 sig_type=std_logic lab=RECb_d3}
C {lab_wire.sym} 220 380 0 0 {name=p56 sig_type=std_logic lab=RECb_d3}
C {lab_wire.sym} 300 380 0 0 {name=p57 sig_type=std_logic lab=SW_RECb_dt}
